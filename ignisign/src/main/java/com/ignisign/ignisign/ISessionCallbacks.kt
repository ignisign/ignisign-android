...
interface ISessionCallbacks {
    fun handlePrivateFileInfoProvisionning(documentId: String, externalDocumentId: String, signerId: String, signatureRequestId: String)//: Deferred<IgnisignDocumentPrivateFileDto>
